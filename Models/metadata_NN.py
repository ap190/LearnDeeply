...
class Model:
    ...
    def construct_graph(self):
        ...
        # TODO: DON'T FORGET TO SWITCH units to self.input_length
        output = keras.layers.Dense(units=1, kernel_initializer='random_normal', name='iam2', activation='linear')(inputs) # linear activation for the last layer
        print("here2")

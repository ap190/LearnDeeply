...
def main():
    ...
    nimaNN = nima_nn.Model()
    # load weights from trained model 

    combined_inputs = keras.layers.concatenate([metaNN.model_inputs, imageNN.model_inputs, nimaNN.model_inputs])
    ...
    nimaNN.layers.load_weights('mobilenet_weights.h5')

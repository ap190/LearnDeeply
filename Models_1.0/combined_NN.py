...
class Model:
    def __init__(self, train_inputs, train_labels,
        ...
        # derived parameters
        self.input_length = self.train_inputs.shape[1].value
        ...
        self.model_outputs = self.construct_graph()
    ...
    def construct_graph(self):
        ...
        inputs = keras.layers.Dense(units=100, kernel_initializer='random_normal', activation='relu')(self.train_inputs)
